    ...
    public class XMLParser {
        ...
        public static List<MapData> ParseMapXML(string xmlURL)
        {
            ...
            foreach (XmlNode parentNode in nodeList)
            {
                ...
                md.R = int.Parse(parentNode.Attributes.GetNamedItem("R").InnerText);
                md.G = int.Parse(parentNode.Attributes.GetNamedItem("G").InnerText);
                md.B = int.Parse(parentNode.Attributes.GetNamedItem("B").InnerText);
